...
@Component({
  selector: 'app-act01',
  templateUrl: './act01.component.html',
  styleUrls: ['./act01.component.css']
})
export class Act01Component implements OnInit {

  idPaciente: string;
  idActividad = '5ec2e4995962e37f011b9ecb';
  actividad: Actividad;
  pacientes: Paciente[];
  imagenes: Imagen[];
  categorias = [];
  ...
  ventanaInfo() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res == true && this.permisoActividad) {
        this.router.navigate(['/actividades/actividad-01-play'], { skipLocationChange: true });
      }
