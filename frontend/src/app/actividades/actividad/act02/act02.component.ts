...
@Component({
  selector: 'app-act02',
  templateUrl: './act02.component.html',
  styleUrls: ['./act02.component.css']
})
export class Act02Component implements OnInit {

  idPaciente: string;
  idActividad = '5ed1f324b50bb702e329832b';
  actividad: Actividad;
  pacientes: Paciente[];
  imagenes: Imagen[];
  categorias = [];
  ...
  goActividad() {
    ...
    if (this.imgSelected.length < 1) {
      ...
      this.mensaje = 'Esta actividad <b> requiere un mínimo de 1 imagen </b> para comenzar.'
  ...
  enviarTarea() {
    ...
    if (this.imgSelected.length < 1) {
      ...
      this.mensaje = 'Esta actividad <b> requiere un mínimo de 1 imagen </b> para enviar.'
  ...
  ventanaInfo() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res == true && this.permisoActividad) {
        this.router.navigate(['/actividades/actividad-02-play'], { skipLocationChange: true });
      }
