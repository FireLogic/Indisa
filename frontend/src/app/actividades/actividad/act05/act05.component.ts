...
@Component({
  selector: 'app-act05',
  templateUrl: './act05.component.html',
  styleUrls: ['./act05.component.css']
})
export class Act05Component implements OnInit {

  idPaciente: string;
  idActividad = '5ed948e5242c18b9df8e8655';
  actividad: Actividad;
  pacientes: Paciente[];
  imagenes: Imagen[];
  categorias = [];
  ...
  goActividad() {
    ...
    if (this.imgSelected.length != 8) {

      this.mensaje = 'Esta actividad <b> requiere 8 imágenes </b> para comenzar.'
  ...
  enviarTarea() {
    ...
    if (this.imgSelected.length != 8) {
      ...
      this.mensaje = 'Esta actividad <b> requiere 8 imágenes </b> para enviar.'
  ...
  ventanaInfo() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res == true && this.permisoActividad) {
        this.router.navigate(['/actividades/actividad-05-play'], { skipLocationChange: true });
      }
