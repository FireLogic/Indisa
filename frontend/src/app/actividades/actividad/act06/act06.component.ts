...
@Component({
  selector: 'app-act06',
  templateUrl: './act06.component.html',
  styleUrls: ['./act06.component.css']
})
export class Act06Component implements OnInit {

  idPaciente: string;
  idActividad = '5ed948f4242c18b9df8e8656';
  actividad: Actividad;
  pacientes: Paciente[];
  imagenes: Imagen[];
  categorias = [];
  ...
  ventanaInfo() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res == true && this.permisoActividad) {
        this.router.navigate(['/actividades/actividad-06-play'], { skipLocationChange: true });
      }
