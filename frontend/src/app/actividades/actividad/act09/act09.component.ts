...
@Component({
  selector: 'app-act09',
  templateUrl: './act09.component.html',
  styleUrls: ['./act09.component.css']
})
export class Act09Component implements OnInit {

  idPaciente: string;
  idActividad = '61539b2d23ef6447e00ee098';
  actividad: Actividad;
  pacientes: Paciente[];
  imagenes: Imagen[];
  categorias = [];
  ...
  ventanaInfo() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res == true && this.permisoActividad) {
        this.router.navigate(['/actividades/actividad-09-play'], { skipLocationChange: true });
      }
