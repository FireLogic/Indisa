...
@Component({
  selector: 'app-act10',
  templateUrl: './act10.component.html',
  styleUrls: ['./act10.component.css']
})
export class Act10Component implements OnInit {

  idPaciente: string;
  idActividad = '61539c3e23ef6447e00ee099';
  actividad: Actividad;
  pacientes: Paciente[];
  imagenes: Imagen[];
  categorias = [];
  ...
  ventanaInfo() {
    ...
    dialogRef.afterClosed().subscribe(res => {
      if (res == true && this.permisoActividad) {
        this.router.navigate(['/actividades/actividad-10-play'], { skipLocationChange: true });
      }
